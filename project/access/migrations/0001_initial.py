...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('access_userprofile', (
            ...
            ('rest_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True)),
        ))
        db.send_create_signal('access', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('access_userprofile')
    ...
    models = {
        'access.userprofile': {
            ...
            'rest_id': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True'}),
